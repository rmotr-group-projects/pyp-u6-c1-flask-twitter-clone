...
def feed():
    ...
    return redirect(url_for('user_tweets', user=session['username']))
...
def user_profile():
    ...
    return render_template("static_templates/profile.html", first_name = first_name, last_name = last_name, birth_date = birth_date, username = username)
